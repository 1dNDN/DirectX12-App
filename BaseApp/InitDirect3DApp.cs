...
{
    public class InitDirect3DApp : DirectXWindow
    {

        protected override void Draw(RealGen.GameTimer gameTimer)
        {
            ...
            RenderCommandList.SetScissorRectangles(ScissorRectangle); // TODO: API suggestion: SetScissorRectangle overload similar to SetViewport
